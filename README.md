...
```
bash <(curl -Ls https://raw.githubusercontent.com/Hamed2211/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Hamed2211/3x-ui/master/install.sh) v2.2.0
```
